...
from src.ui.widgets.app_bottom_bar_widget import AppBottomBarWidget
from src.ui.widgets.app_mode_switcher_widget import ApplicationMode, AppModeSwitcherWidget
from src.ui.widgets.app_top_bar_widget import AppTopBarWidget
from src.ui.widgets.modes.app_text_utilities_widget import AppTextUtilitiesWidget
from src.ui.widgets.modes.app_translator_widget import AppTranslatorWidget
...
class AppMainContentWidget(QWidget):
    ...
    def __init__(self, app_context: AppContext, parent=None):
        ...
        models = app_context.llm_provider.get_available_models()
